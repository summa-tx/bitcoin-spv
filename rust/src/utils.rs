...
pub mod test_utils {
    ...
    pub fn match_string_to_err(s: &str) -> SPVError {
        match s {
            ...
            "HashBE is not the BE version of Hash" => SPVError::NonMatchingDigests,
            "MerkleRootBE is not the BE version of MerkleRootLE" => SPVError::NonMatchingMerkleRoots,
            ...
            "Prevhash is not the BE version of PrevhashLE" => SPVError::NonMatchingPrevhashes,
