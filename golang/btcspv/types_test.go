...
type InvalidHeadersCases struct {
	Header btcspv.BitcoinHeader `json:"header"`
	Error  string               `json:"e"`
}
...
type TypesSuite struct {
	...
	ValidProofs  []btcspv.SPVProof
	ValidHeaders []btcspv.BitcoinHeader
}
...
func (suite *TypesSuite) TestValidateSPVProof() {
	...
	invalidHeader.ConfirmingHeader.MerkleRoot = btcspv.Hash256Digest{0xdd, 0xe2, 0x5e, 0x5d, 0x1c, 0xb2, 0x9a, 0xc6, 0xc0, 0x8b, 0xe7, 0x37, 0x83, 0x73, 0xc6, 0x46, 0xad, 0x18, 0xfc, 0x90, 0xb1, 0x44, 0x35, 0xa9, 0x2a, 0xc8, 0xab, 0x42, 0x28, 0xc9, 0x1a, 0xb6}
...
func (suite *TypesSuite) TestNewHash160Digest() {
	...
	output := btcspv.Hash160Digest{0x1b, 0x60, 0xc3, 0x1d, 0xba, 0x94, 0x3, 0xc7, 0x4d, 0x81, 0xaf, 0x25, 0x5f, 0xc, 0x30, 0xb, 0xfe, 0xd5, 0xfa, 0xa3}
...
func (suite *TypesSuite) TestNewHash256Digest() {
	...
	output := btcspv.Hash256Digest{0x14, 0x06, 0xe0, 0x58, 0x81, 0xe2, 0x99, 0x36, 0x77, 0x66, 0xd3, 0x13, 0xe2, 0x6c, 0x05, 0x56, 0x4e, 0xc9, 0x1b, 0xf7, 0x21, 0xd3, 0x17, 0x26, 0xbd, 0x6e, 0x46, 0xe6, 0x06, 0x89, 0x53, 0x9a}
	...
	output = btcspv.Hash256Digest{0x4f, 0x8b, 0x42, 0xc2, 0x2d, 0xd3, 0x72, 0x9b, 0x51, 0x9b, 0xa6, 0xf6, 0x8d, 0x2d, 0xa7, 0xcc, 0x5b, 0x2d, 0x60, 0x6d, 0x05, 0xda, 0xed, 0x5a, 0xd5, 0x12, 0x8c, 0xc0, 0x3e, 0x6c, 0x63, 0x58}
